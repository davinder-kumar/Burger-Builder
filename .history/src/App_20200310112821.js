...
const App = (props) => {
    ...
    if (props.isAuth) {
        routes_ = (
            <Switch>
                <Route path={routes.checkout} render={() =>{ return <Checkout /> }} />
                <Route path={routes.orders} render={() =>{ return <Orders /> }} />
                <Route path={routes.logout} render={() =>{ return <Logout /> }} />
                <Route path={routes.auth} render={() =>{ return <Auth /> }} />
