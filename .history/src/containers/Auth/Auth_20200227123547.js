...
class Auth extends Component {
    ...
    render() {
        ...
        <Button clicked={(e) => this.onSwitchAuthHandler(e)} btnType="Danger">Proceed to {this.state.isSignup ? "SIGNUP" : "SIGNIN"}</Button>
                </form>
            </div>
        )
    }
...
export const mapDispatchToProps = (dispatch) => {
    return {
        onAuth: (email, password,isSignup) => dispatch(auth(email, password))
    }
}
