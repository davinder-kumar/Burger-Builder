...
const Auth = props => {
    ...
    const {buildingBurger,AuthRedirectPath,onSetAuthPath}
    useEffect(() => {
    ...
    return (
        <div className={classes.Auth}>
            ...
            <form style={{ textAlign: "center" }}>
                {form}
                <Button clicked={(e) => onSubmitHandler(e)} btnType="Success">SUBMIT</Button>
                <Button clicked={(e) => onSwitchAuthHandler(e)} btnType="Danger">Proceed to {isSignup ? "Sign In" : "Sign Up"}</Button>
            </form>
        </div>
    )
}
